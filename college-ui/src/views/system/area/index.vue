...
<!--      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="areaList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" align="center" prop="deptId" width="100" />
      <el-table-column
        label="区域名称"
        align="center"
        prop="deptName"
  ...
  export default {
    ...
    methods: {
      ...
      typeFormat(row, column) {
        return this.selectDictLabel(this.typeOptions, row.deptName);
      },
      // 取消按钮
      cancel() {
        this.open = false;
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除区域编号为"' + deptIds + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delArea(deptIds);
        }).then(() => {
          this.getList();
