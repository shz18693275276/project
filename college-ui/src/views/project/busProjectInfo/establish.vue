      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="220">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['project:establish:detail']"
          >详情</el-button>
          <el-button
            ...
            v-hasPermi="['project:establish:edit']"
          >更新</el-button>
          <el-button
			v-if="scope.row.status==31"
            size="mini"
            ...
            v-hasPermi="['project:establish:submit']"
          >提交</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { listEstablish, getBusProjectInfo, delBusProjectInfo, addBusProjectInfo, updateBusProjectInfo, exportBusProjectInfo,updatePorjectStatus } from "@/api/project/busProjectInfo";
