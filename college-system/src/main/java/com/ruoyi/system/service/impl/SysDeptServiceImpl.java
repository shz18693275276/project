...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    @Override
    public  List<SysDept> selectAreaList(SysDept dept)
    {
        List<SysDept>  list  = deptMapper.selectAreaList(dept);
        return list;
    }
     ...
     */
    @Override
    public String checkDeptNameUnique2(SysDept dept)
    {
        Long deptId = StringUtils.isNull(dept.getDeptId()) ? -1L : dept.getDeptId();

        //下面 这个 方法  checkDeptNameUnique  是共用的 不要改
        SysDept info = deptMapper.checkDeptNameUnique(dept.getDeptName(), dept.getParentId());
